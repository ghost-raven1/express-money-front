...
const MainTariffsListCard = ({item}) => {
    ...
    function cardBackgroundStyles (type) {
        ...
        if (type === 'standard') return 'tariffs-list-card tariffs-list-card_standard'
        if (type === 'premium') return 'tariffs-list-card tariffs-list-card_premium'
    }
    function cardTitleStyles (type) {
        if (type === 'basic') return 'tariffs-list-card__title tariffs-list-card__title_basic'
        if (type === 'standard') return 'tariffs-list-card__title tariffs-list-card__title_standard'
        if (type === 'premium') return 'tariffs-list-card__title tariffs-list-card__title_premium'
    }
    ...
    return (
        <div className={cardBackgroundStyles(item.type)}>
            ...
            <div className="tariffs-list-card-bottom">
                <div>{item.price} Руб на {item.count} {countTypeRU(item.countType)}</div>
