  ...
  const advantages = [
    {
      ...
      title: "Моментально",
      desc: "Деньги за 5 минуту \n после одобрения",
    },
    {
      img: mainAdvantagesIcon2,
      title: "Без страховки",
      desc: "Без доп. платежей \n к выданной сумме",
    },
    {
      img: mainAdvantagesIcon3,
      title: "Одобрение 99%",
      desc: "Безопасность персональных \n данных",
    },
    {
      img: mainAdvantagesIcon4,
      title: "Без переплат",
      desc: "Погашение займа за 24 часа \n без комиссии",
    },
    {
      img: mainAdvantagesIcon5,
      title: "Любим клиентов",
      desc: "Премиум услуги для постоянных \n клиентов компании",
    },
    {
      img: mainAdvantagesIcon6,
      title: "Работаем честно",
      desc: "Улучшение Вашей \n кредитной истории",
    },
  ];
  return (
