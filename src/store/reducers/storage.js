...
export const uploadFileAsync = ({ data }) => async (dispatch) => {
    await api.post(`/storage/upload_file`, data)
        .then((r) => {
...
export const userFileDownloadAsync = ({ name }) => async (dispatch) => {
    await api.get(`/storage/user_file/${name}/download`)
        .then((r) => {
...
export const getUserFileAsync = ({ name }) => async (dispatch) => {
    await api.get(`/storage/user_file/${name}`)
        .then((r) => {
...
export const getUserFileListAsync = ({params}) => async (dispatch) => {
    await api
